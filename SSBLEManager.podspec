#
#  Be sure to run `pod spec lint SSBLEManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "LemmonCH"
  # spec.authors            = { "LemmonCH" => "1806096107@qq.com" }
  # spec.social_media_url   = "https://twitter.com/LemmonCH"
